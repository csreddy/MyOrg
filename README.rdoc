...
3. You can attach a photo for each employee which shows up in employee details & index
	page
4. Displays geographic distribution of employees on Google Maps across the US based on 
	their home address
...
2. Change directory to <tt>myorg</tt> and start the web server:
       <tt>cd myorg; rails server</tt> (run with --help for options)
